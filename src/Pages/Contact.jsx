...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const formSubmitUrl = "https://formsubmit.co/martogisiagian17@gmail.com";
  ...
  return (
    <div className="px-[5%] sm:px-[5%] lg:px-[10%] ">
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        ...
        >
          Open to ideas, collaborations, or a quick chat feel free to reach out.
        </p>
      </div>
            ...
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <p className="text-gray-400">
                  Got a question or idea? Drop a message and let’s connect.
                </p>
              </div>
