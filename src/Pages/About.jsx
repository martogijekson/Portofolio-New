...
const Header = memo(() => (
  <div className="text-center lg:mb-8 mb-2 px-[5%]">
    ...
    >
      ...
      Crafting digital solutions from innovative ideas
      <Sparkles className="w-5 h-5 text-purple-400" />
    </p>
  </div>
));
          ...
          <div className="space-y-6 text-center lg:text-left">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold">
              ...
              <span className="block mt-2 text-gray-200">
                Martogi Jekson C. Siagian
              </span>
            </h2>
            <p className="text-base sm:text-lg lg:text-xl text-gray-400 leading-relaxed text-justify pb-4 sm:pb-0">
              Computer Engineering graduate with experience in web and
              application development through academic projects and MBKM.
              Enthusiastic about technology, application development, web, and
              artificial intelligence (AI). Eager to learn, build, and grow to
              create technology that will have an impact in the future.
            </p>
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 w-full">
              <a
                href="https://drive.google.com/drive/folders/1e9hn8Z6h00w6lRmy4AvEyHHn7SnapL4w?usp=sharing"
