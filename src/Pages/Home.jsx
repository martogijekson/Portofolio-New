...
const WORDS = ["Electrical & Computer Engienering", "Tech Enthusiast"];
const TECH_STACK = ["React", "Javascript", "Laravel", "IoT"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/martogijekson" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/martogi-jekson/" },
  { icon: Instagram, link: "https://www.instagram.com/martogijksn" },
];
...
const Home = () => {
  ...
  // Lottie configuration (rendererSettings dihapus agar tidak warning)
  const lottieOptions = {
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                <p
                  ...
                  data-aos-delay="1000"
                >
                  A journey of learning, building, and growing to create
                  technology that will have an impact in the future.
                </p>
